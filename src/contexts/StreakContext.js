...
export const BADGES = [
  ...
  },
  {
    ...
    icon: '🎯',
    criteria: (stats) => stats.activityCounts.event_joined >= 1
  },
  {
    id: 'event_enthusiast',
    name: 'Event Enthusiast',
    description: 'Join 3 seasonal events',
    icon: '🌟',
    criteria: (stats) => stats.activityCounts.event_joined >= 3
  },
  {
    ...
    icon: '🏅',
    criteria: (stats) => stats.activityCounts.event_completed >= 1
  },
  {
    id: 'event_master',
    name: 'Event Master',
    description: 'Complete 5 seasonal events',
    icon: '🎖️',
    criteria: (stats) => stats.activityCounts.event_completed >= 5
  }
];
